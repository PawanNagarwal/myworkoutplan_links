...
# from utils import   # add at top of file
...
def main():
    ...
    if st.session_state.page == 'form':
        ...
        try:
            ...
            daysdata = generator.parse_workout_plan(workout_plan_json)

# Fetch YouTube links after plan is parsed
            # with st.spinner("Fetching YouTube video links for exercises..."):
            #     daysdata = fetch_youtube_links_for_plan(
            #         daysdata,
            #         st.session_state.formdata.get("fitnesslevel", "")
            #     )

            st.session_state.daysdata = daysdata
            # days_data = generator.parse_workout_plan(workout_plan_json)
            for day in daysdata:
                for ex in day.get("exercises", []):
                    print(ex.get("exercisename"), "->", ex.get("youtube_link"))
            st.session_state.workout_plan = workout_plan_json
            st.session_state.days_data = daysdata
